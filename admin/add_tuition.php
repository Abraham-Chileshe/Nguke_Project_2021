    ...
    <div class="py-5 w3-text-light-grey container">
           <div class="mt-4 w3-white">
            <div class="pl-4 pr-4 pt-3 pb-3">
                <h3 class="mt-4">Add a New Tuition</h3><hr/>

                <form enctype="multipart/form-data" method="Post" action="func/add_tuition.php">
                    <label class="mt-1 w3-label">Subject</label>
                    ...
                    <input type="text" name="amount1"  class="w3-input w-80 mb-4" required/><br/>
