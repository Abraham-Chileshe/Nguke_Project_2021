   ...
   <header>
       <div class="">
           <ul class="w3-navbar w3-black">
               <li><a href="index.php" class="w3-text-white w3-hover-red ">Home</a><li>
               <li><a href="#" class="w3-text-white w3-hover-red ">About</a><li>
               <li><a href="#" class="w3-text-white w3-hover-red ">Product</a><li>
                <li class="w3-dropdown-hover">
                    <a href="#" class="w3-text-white w3-hover-red ">Dropdown</a>
    ...
    <div class="py-5 w3-text-light-grey container">
           <div class="mt-4 w3-white">
            <div class="pl-4 pr-4 pt-3 pb-3">
                ...
                <form enctype="multipart/form-data" method="Post" action="func/price_tuition_edit.php?ID=<?php echo$id;?>">
